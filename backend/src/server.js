...
const corsOptions = {
  origin: function (origin, callback) {
    const allowedOrigins = (process.env.CORS_ORIGIN || 'http://localhost:3000,http://localhost:3001,http://localhost:3002,http://localhost:5173,https://haritnavinya.onrender.com,https://haritnavinya-frontend.onrender.com,https://haritnavinya.netlify.app').split(',');
