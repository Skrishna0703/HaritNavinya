...
export function SoilDataInsights({ onBack }: SoilDataInsightsProps) {
  ...
  const API_BASE = `${import.meta.env.PROD ? (import.meta.env.VITE_API_BASE_URL || 'https://haritnavinya.onrender.com') : (import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000')}/api/soil`;
